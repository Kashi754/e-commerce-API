...
module.exports = {
    ...
    addItemToCart: async (cartId, itemData, done) => {
        try {
    ...
    editCartProduct: async (cartId, itemData, done) => {
        try {
            const { productId, qty } = itemData;
    ...
    deleteCartProduct: async (cartId, productId, done) => {
        try {
    ...
    checkoutCart: async (cartId, paymentInfo, done) => {
        const {
            payment_information,
            billing_address,
            shipping_address,
